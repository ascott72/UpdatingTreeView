    ...
    $.widget("roicp.treeview", {
        ...
        _createNode: function (dataSource, parentElement) {
            for (var i = 0; i < dataSource.length; i++) {
                ...
                var nodeInnerTag = $("<li />");
                nodeInnerTag.attr("id", item.NodeID);
                ...
                nodeSpanHit.attr("id", item.NodeID);
